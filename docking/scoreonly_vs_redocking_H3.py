...
r, _ = pearsonr(df["Vina_Score_H3"], df["Redocking_Vina_Score_H3"])

plt.figure(figsize=(9, 4.5))
plt.scatter(df["Vina_Score_H3"], df["Redocking_Vina_Score_H3"], c="black", alpha = 0.7)
...
plt.ylabel("Redocking Vina Affinity (kcal/mol)")
plt.title("Re-docking vs. In Place Vina Affinity Estimates (Whole Complex)")
plt.grid(True)
...
y_min, y_max = df["Redocking_Vina_Score_H3"].min(), 0
...
plt.savefig("scoreonly_vs_redocking.png")
